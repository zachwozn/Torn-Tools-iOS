...
`);
	...
	//#endregion
	//#region extension/features/api-demo/api-demo.ts
	function loadAPIDemo() {
		if (!settings.pages.api.autoDemo) return;
		document.querySelector("#documentation").style.setProperty("display", "none");
		document.querySelector("#demo").style.removeProperty("display");
	}
	//#endregion
	//#region extension/features/api-selections/api-selections.ts
	...
	typeof navigator !== "undefined" && /Safari/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) && /Chromium/.test(navigator.userAgent);
	function hasAPIData() {
	...
	//#endregion
	//#region extension/features/auto-api-fill/auto-api-fill.ts
	function loadAutoAPIFill() {
		...
		executeScript(browser$1.runtime.getURL("/api-key-focus--inject.js"));
	}
	//#endregion
	//#region extension/features/auto-pretty/auto-pretty.ts
	function loadAPIPretty() {
		if (!settings.pages.api.autoPretty) return;
		findAllElements("input[value=pretty]").forEach((p) => p.checked = true);
	}
	//#endregion
	//#region extension/entrypoints/api-features.content.ts
	...
	*/
	function getUniqueEventName(eventName) {
		return `${browser$1?.runtime?.id}:api-features:${eventName}`;
	}
	//#endregion
	...
	*/
	var ContentScriptContext = class ContentScriptContext {
		...
		get isInvalid() {
			if (browser$1.runtime?.id == null) this.notifyInvalidated();
	...
	//#endregion
	//#region \0virtual:wxt-content-script-isolated-world-entrypoint?/Users/zachwozniak/Desktop/torntools_extension/extension/entrypoints/api-features.content.ts
