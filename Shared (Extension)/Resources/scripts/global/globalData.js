...
const DEFAULT_STORAGE = {
	...
	settings: {
		...
		notifications: {
			...
			types: {
                global: new DefaultSetting({
                                type: "boolean",
                                defaultValue: () => {
                                    // Safely check for Notification API availability and permission
                                    if (typeof Notification !== 'undefined') {
                                        return Notification.permission === "granted";
                                    }
                                    return false; // Default to false if Notification API is unavailable
                                }
                            }),
		...
		pages: {
			...
			travel: {
				...
				autoTravelTableCountry: new DefaultSetting({ type: "boolean", defaultValue: true }),
		...
		external: {
			...
			prometheus: new DefaultSetting({ type: "boolean", defaultValue: true }),
